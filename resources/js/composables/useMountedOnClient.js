...
// but contains mismatches" warning, caught building invue/actions
// against an SSR-enabled consuming app (Invue-Docs). The teleported
// content here (a confirmation modal, a dropdown menu) is always closed
// on first render anyway, so skipping it server-side changes nothing
// visually — it just avoids asking Vue's SSR renderer to reconcile a
// teleport target it can't reliably match against the client.
